        ...
        <div className="w-screen h-screen flex">
            ...
            <div className="h-full w-2/6 bg-gradient-to-b from-[#11001c] to-[#190028] flex flex-col items-center gap-10">
                ...
                <div className="w-full grid place-items-center">
                    <form action="" onSubmit={(e) => e.preventDefault()} className="w-3/4 px-32 flex flex-col gap-6 text-xl">
                        <Input startContent={<Mail />} label="Email" type="email" isRequired variant="flat" color="secondary"/>
