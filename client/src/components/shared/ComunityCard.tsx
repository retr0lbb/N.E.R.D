...
export const ComunityCard: React.FC<ComunityProps> = ({ComunityName, comunityAvatar, src}) => {
    return(
        <div className="relative w-[32rem] h-[22rem] rounded-2xl bg-red-500 overflow-hidden">
